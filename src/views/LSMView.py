...
class LSMView:
    def __init__(self, root, controller):
        ...
        consecutivos = datos["consecutivo"]
        ...
        self.modelo_var = tk.StringVar(value=version[0])  # Primera versión
        ttk.Combobox(root, textvariable=self.modelo_var, values=version).pack(pady=5)
    ...
    def generar_codigo(self):
        ...
        codigo_qr = f"MXF_{modelo}{corrida}{año}{semana}{consecutivo}"
